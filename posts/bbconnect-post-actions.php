...
function bbconnect_post_actions() {
	
	return apply_filters( 'bbconnect_post_actions', array( 
...
function bbconnect_get_init_post_actions() {
	return apply_filters( 'bbconnect_get_init_post_actions', bbconnect_post_actions() ); 
}
...
function bbconnect_get_post_actions() {
	return apply_filters( 'bbconnect_get_post_actions', bbconnect_post_actions() ); 
}
 ...
 * @return null If you don't see your actions, it didn't work. :)
 */
function bbconnect_init_post_actions() {
  
  	$bbconnect_post_actions = bbconnect_get_init_post_actions();
  	
	foreach ( $bbconnect_post_actions as $action ) {
		...
		$args = bbconnect_init_post_actions_args( $labels, $cptype, $args );
		/*
		//$args['label'] = null;
		$args['labels'] = $labels;
		$args['description'] = '';
		...
		$args['register_meta_box_cb'] = 'bbconnect_post_actions_meta_box_cb';
...
function bbconnect_init_post_actions_args( $labels, $cptype, $args = null ) {
	...
	$defaults = array( 
						...
						'map_meta_cap' => false, 
						'hierarchical' => false, 
						'register_meta_box_cb' => 'bbconnect_post_actions_meta_box_cb', 
						'taxonomies' => array(), 
...
function bbconnect_post_actions_nonce_field() {
	global $post, $ppnonce;
	if ( false == $ppnonce ) {

...
/**
 * Push the user actions meta to Connexions if this is a processed item.
 *
 * @since 1.0.0
 *
 * @param arr. The Connexions user actions meta array.
 *
 * @return arr. The filtered Connexions user actions meta array.
 */

...
/**
 * This is the wrapper function for the Connexions Options API. Your function might be called {prefix}_options. It outputs the options page with the activated option tab + contents.
 *
 * @since 1.0.2
 */
function bbconnect_options() {
    ...
    $navigation = apply_filters('bbconnect_options_tabs', array(
            ...
            'bbconnect_licence_settings' => array(
                    'title' => __('Licence', 'bbconnect'),
                    'subs' => false,
            ),
    ...
    bbconnect_options_form(__('Connexions Options', 'bbconnect'), $navigation);
}

/**
 * This function saves Connexions Options data at init to catch taxonomic options.
 *
 * @since 1.0.2
 */
...
/**
 * This is the main function for the Connexions Options API.
 *
 * @since 1.0.2
 *

...
function bbconnect_account_information_fields() {
    return array(
            ...
            // User Source
            array('source' => 'bbconnect', 'meta_key' => 'source', 'tag' => '', 'name' => __('User Source', 'bbconnect'), 'options' => array('admin' => true, 'user' => false, 'signup' => false, 'reports' => true, 'public' => false, 'req' => false, 'field_type' => 'select', 'choices' => array('manual' => __('Manually Created', 'bbconnect'), 'form' => __('Form Submission', 'bbconnect'), 'import' => __('Import', 'bbconnect'), 'mailchimp' => __('MailChimp', 'bbconnect'), '' => __('Unknown', 'bbconnect'))), 'help' => ''),
...
function bbconnect_contact_information_fields() {
    return array(
            ...
            array( 'source' => 'user', 'meta_key' => 'additional_email', 'tag' => '', 'name' => __( 'Additional Email Addresses', 'bbconnect' ), 'options' => array( 'admin' => true, 'user' => true, 'signup' => false, 'reports' => true, 'public' => false, 'req' => false, 'field_type' => 'multitext', 'choices' => array( __( 'home', 'bbconnect' ) => __( 'Home', 'bbconnect' ), __( 'work', 'bbconnect' ) => __( 'Work', 'bbconnect' ), __( 'other', 'bbconnect' ) => __( 'Other', 'bbconnect' ), __( 'archive', 'bbconnect' ) => __( 'Archive', 'bbconnect' ) ) ), 'help' => '' ),

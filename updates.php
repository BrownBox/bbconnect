...
if( !class_exists('BBPLUGINAPI') ) {
    class BBPLUGINAPI {
    	...
    	function bbconnect_api_plugin_check( $transient ) {
    	    ...
    	    $args = array(
    	     	'bbconnect' => 'wppu',
    	        'bbc_action' => 'plugin-update',
    	        'bbc_item' => $this->plugin_id,
     	        'bbc_slug' => $this->plugin_slug,
    	        'bbc_version' => $transient->checked[$this->plugin_path],
    	        'bbc_key' => get_option( $this->plugin_slug.'_license_key' ),
    	        'bbc_site' => get_option( 'siteurl' ),
    	    );

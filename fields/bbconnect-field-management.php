				...
				<span class="bbconnect-field">
					<ul class="field-options">
						<li>
							...
							<a class="umt user <?php if ( true == $user_meta['options']['user'] ) { echo 'on'; } else { echo 'off'; } ?>" title="user_<?php echo $meta_key; ?>"><input type="hidden" id="user_<?php echo $meta_key; ?>"  name="bbconnect_user_meta_options[<?php echo $meta_key; ?>][options][user]" value="<?php echo $user_meta['options']['user']; ?>" /><?php _e( 'User', 'bbconnect' ); ?></a>

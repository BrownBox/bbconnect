...
class Tax_Meta_Class {
  ...
  public function load_scripts_styles() {
    ...
    if (in_array($taxnow,$this->_meta_box['pages'])){
      ...
      wp_enqueue_style( 'tax-meta-clss', $plugin_path . '/assets/c/Tax-meta-class.css' );
      // Enqueue Meta Box Scripts
      wp_enqueue_script( 'tax-meta-clss', $plugin_path . '/assets/j/tax-meta-clss.js', array( 'jquery' ), null, true );
    }
  }
